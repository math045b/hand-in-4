...
const (
	...
	Service_RemoveNode_FullMethodName  = "/proto.Service/RemoveNode"
)
...
type ServiceClient interface {
	...
	ConnectNode(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error)
	RemoveNode(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error)
}
...
func (c *serviceClient) SendMessage(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error) {
...
func (c *serviceClient) ConnectNode(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Message)
...
func (c *serviceClient) RemoveNode(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Message)
...
type ServiceServer interface {
	...
	ConnectNode(context.Context, *Message) (*Message, error)
	RemoveNode(context.Context, *Message) (*Message, error)
...
func (UnimplementedServiceServer) SendMessage(context.Context, *Message) (*Message, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SendMessage not implemented")
}
func (UnimplementedServiceServer) ConnectNode(context.Context, *Message) (*Message, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ConnectNode not implemented")
}
func (UnimplementedServiceServer) RemoveNode(context.Context, *Message) (*Message, error) {
...
func _Service_RemoveNode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceServer).RemoveNode(ctx, req.(*Message))
	}
	return interceptor(ctx, in, info, handler)
}
